...
<div class="container mt-5">
    <div class="card shadow p-4">
        <h2 class="mb-4 text-center">Edit Data Tanaman Pangan</h2>
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="namaBarang" name="nama_pangan" placeholder="Masukan nama tanaman" value="<?= $data['nama_pangan'] ?>">
                </div>
                <div class="col-md-4">
                    <label for="jumlah" class="form-label fw-bold">Jumlah</label>
                    <input type="text" class="form-control" id="jumlah" name="jumlah" placeholder="Contoh 100 pohon / 100 M²" value="<?= $data['jumlah'] ?>">
                </div>
            </div>
