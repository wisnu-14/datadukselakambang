...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: ?pages=data_ternak");
    exit;
}
$data = showNoRumah();
$row = index();
?>
<style>
    <?php require '../../public/css/ternak.css'; ?>
</style>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <h2 class="mb-4 text-center">Input Data Ternak</h2>
                        <form action="" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="namaBarang" name="nama_ternak" placeholder="Masukan nama ternak" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="jumlah" class="form-label fw-bold">Jumlah</label>
                                    <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Masukan Jumlah per ekor" required>
                                </div>
                            </div>
...
<div class="container mt-5">
    <div class="card p-4 shadow-sm">
        <h2 class="mb-4 text-center">Data Ternak</h2>
                    ...
                    foreach ($row as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="../ternak/delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?');" class="btn btn-dark btn-custom">🗑 Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<script>
    function openEditPage(id) {
        window.open("?pages=edit_data_ternak&id=" + id, "_blank", "width=1000,height=400");
    }
</script>
<script>
    function searchData() {
