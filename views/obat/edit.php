...
<div class="container mt-5">
    <div class="card shadow p-4">
        <h2 class="mb-4 text-center">Edit Data Tanaman Obat</h2>
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="namaBarang" name="nama_obat" placeholder="Masukan nama tanaman" value="<?= $data['nama_obat'] ?>">
                </div>
                <div class="col-md-4">
