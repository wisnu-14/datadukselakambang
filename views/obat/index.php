...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: ?pages=tanaman_obat");
    exit;
}
$data = showNoRumah();
$row = index();
?>
<style>
    <?php require '../../public/css/obat.css'; ?>
</style>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <h2 class="mb-4 text-center">Input Data Tanaman Obat</h2>
                        <form action="" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="namaBarang" name="nama_obat" placeholder="Masukan nama tanaman" required>
                                </div>
                                <div class="col-md-4">
...
<div class="container mt-5">
    <div class="card p-4 shadow-sm">
        <h2 class="mb-4 text-center">Data Tanaman Obat</h2>
                    ...
                    foreach ($row as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="../obat/delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?');" class="btn btn-dark btn-custom">🗑 Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<script>
    function openEditPage(id) {
        window.open("?pages=edit_tanaman_obat&id=" + id, "_blank", "width=1000,height=400");
    }
</script>
<script>
    function searchData() {
