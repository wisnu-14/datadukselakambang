...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: ?pages=data_barang");
    exit;
}
$data = showNoRumah();
$row = index();
?>
<style>
    <?php require '../../public/css/barang.css'; ?>
</style>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <h2 class="mb-4 text-center">Input Data Barang</h2>
                        <form action="" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label for="namaBarang" class="form-label fw-bold">Kendaraan/Elektronik</label>
                                    <input type="text" class="form-control" id="namaBarang" name="nama_barang" placeholder="Masukan Merek Barang" required>
                                </div>
                                <div class="col-md-4">
                    ...
                    foreach ($row as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="../barang/delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?');" class="btn btn-dark btn-custom">🗑 Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<script>
    function openEditPage(id) {
        window.open("?pages=edit_barang&id=" + id, "_blank", "width=800,height=400");
    }
</script>
<script>
    function searchData() {
