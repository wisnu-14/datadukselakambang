...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: ?pages=data_air");
    exit;
}
$data = showNoRumah();
$row = index();
?>
<style>
    <?php require '../../public/css/air.css'; ?>
</style>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <h2 class="mb-4 text-center">Input Data Sumber Air</h2>
                        <form action="" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="namaBarang" name="sumber_air" placeholder="Masukan sumber air">
                                </div>
                                <div class="col-md-4">
...
<div class="container mt-5">
    <div class="card p-4 shadow-sm">
        <h2 class="mb-4 text-center">Data Sumber Air</h2>
                    ...
                    foreach ($row as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="../air/delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?');" class="btn btn-dark btn-custom">🗑 Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<script>
    function openEditPage(id) {
        window.open("?pages=edit_data_air&id=" + id, "_blank", "width=1000,height=400");
    }
</script>
<script>
    function searchData() {
